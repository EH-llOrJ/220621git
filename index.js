...
//브런치 추가
//git branch "추가하고 싶은 브런치 이름" ex)git branch pick
...
//리드미 작성
//1. 글씨의 크기
//#을 입력하고 한 칸 띄어쓰고 뒤에 글씨를 작성
//#은 5개까지 입력할 수 있다.(많을수록 작아진다.)

//2. 코드 사용
//```사용하는 언어 ex)```javascript
//백틱 3개로 시작하고 뒤에 사용하는 언어를 붙여준다.
//코드 내용을 작성한 후
//```로 닫아준다.
